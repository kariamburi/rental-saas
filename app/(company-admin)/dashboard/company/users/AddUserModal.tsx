...
import { Eye, EyeOff, LockKeyhole, Mail, Plus, UserRound, X } from "lucide-react";
import { createCompanyStaffUser } from "./actions";


export default function AddUserModal({ companyId }: { companyId: string }) {
    ...
    function handleSubmit(formData: FormData) {
        ...
        startTransition(async () => {
            try {
                await createCompanyStaffUser(formData);
                setOpen(false);
            } catch (err: any) {
                    ...
                    >
                        <div className="flex items-center justify-between border-b border-slate-200 px-5 py-4">
                            <div>
                                ...
                                <p className="text-sm font-semibold text-slate-500">
                                    Create a company staff account.
                                </p>
                            </div>
                        ...
                        <form action={handleSubmit} className="space-y-4 p-5">
                            ...
                            <Input
                                ...
                                label="Full Name"
                                name="name"
                                placeholder="Example: Mary Wanjiku"
                            />
                            ...
                            <Input
                                ...
                                name="email"
                                type="email"
                                placeholder="staff@company.co.ke"
                            />
